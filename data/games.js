...
window.HUB_GAMES = [
  ...
  },
  {
    ...
    // bundle.game_data bằng games/ghe-nong/_tools/build_tfm.py (RESEARCH.md §12). Phần còn lại
    // lấy DỮ LIỆU THIẾT KẾ, đọc từ ảnh chụp trong game: 7 ảnh Steam của TFM2, 4 ảnh Umamusume, ba trailer,
