...
(function (G) {
  ...
  G.HEROES = [
    ...
    h('fubuki', 'Shirakami Fubuki', 'SS', 'blade', 'water', 'Fubuki',
    ...
    h('noel', 'Shirogane Noel', 'SS', 'blade', 'light', 'Noel',
      'Hiệp sĩ trắng. Đứng đúng chỗ, bắn đúng nhịp, không lùi một bước.'),

    /* ----------------------------------------------------------------- S -- */
    h('ayame', 'Nakiri Ayame', 'S', 'blade', 'dark', 'Ayame',
    ...
    h('coco', 'Kiryu Coco', 'S', 'orb', 'fire', 'Coco',
    ...
    h('mio', 'Ookami Mio', 'S', 'scythe', 'earth', 'Mio',
    ...
    h('sana', 'Tsukumo Sana', 'A', 'orb', 'earth', 'Sana',
    ...
    h('luna', 'Himemori Luna', 'B', 'blade', 'none', 'Luna',
    ...
    h('moona', 'Moona Hoshinova', 'B', 'orb', 'water', 'Moona',
      'Trăng. Phép nước lên xuống theo con nước.'),
    h('kobo', 'Kobo Kanaeru', 'B', 'orb', 'water', 'Kobo',
