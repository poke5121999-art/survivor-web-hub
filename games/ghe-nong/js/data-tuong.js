  ...
  G.TUONG = [
    ...
    T('phapset', 'Pháp Sét', 'phep', 'giua',
      ...
      N('Tích Điện', 'Cứ 3 đòn/kỹ năng trúng mục tiêu thì đòn kế tiếp làm choáng 0.6 giây.',
        { moiN: 3, kc: 0.6 }),
      C('Tia Chớp', 'Sét nảy qua 3 mục tiêu: 75 + 92% sức mạnh phép, giảm 15% mỗi lần nảy.', 6,
        { dmg: { g: 0.92, c: 75, loai: 'pt' }, nay: 3, giamNay: 0.15 }),
    ...
    T('nhacsi', 'Nhạc Sĩ', 'ho', 'ho',
      ...
      N('Khúc Hành', 'Đồng đội quanh mình luôn được +14% tốc chạy và +11% tốc đánh.',
        { hao: { tocchay: 0.14, tocdanh: 0.11 }, doi: true }),
