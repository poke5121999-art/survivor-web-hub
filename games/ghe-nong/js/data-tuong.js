...
(function (G) {
  ...
  G.TUONG = [
    ...
    T('kiemsi', 'Kiếm Sĩ', 'can', 'tren',
      ...
      C('Chém Vòng', 'Chém một vòng quanh mình: 40 + 110% sát thương vật lý lên mọi kẻ địch gần.', 7,
        { dmg: { g: 1.10, c: 40, loai: 'vl', dien: true } }),
      U('Bão Kiếm', 'Xoay kiếm 3 giây, mỗi giây gây 60 + 60% sát thương vật lý diện rộng.', 55,
        { dmg: { g: 0.60, c: 60, loai: 'vl', dien: true }, lap: 3 }),
    ...
    T('bongma', 'Bóng Ma', 'sat', 'rung',
      ...
      N('Không Dấu Chân', 'Trong rừng: +12% tốc chạy và không hiện trên bản đồ nhỏ của đối thủ.',
        { buff: { tocchayRung: 0.12 }, dac: 'anminh' }),
      C('Xuyên Tường', 'Đi xuyên địa hình một đoạn; đòn đánh kế tiếp gây thêm 60% sát thương.', 12,
        { dmg: { g: 0.60, loai: 'vl' }, dac: 'xuyen' }),
    ...
    T('tuchien', 'Tử Chiến', 'sat', 'giua',
      [94, 22, 0, 0, 860, 84, 23, 6, 16, 3, 27, 1.20, 78],
    ...
    T('bomxich', 'Bom Xích', 'xa', 'duoi',
      [76, 20, 22, 6, 820, 80, 19, 5, 16, 3, 50, 1.15, 72],
    ...
    T('hiepsi', 'Hiệp Sĩ', 'can', 'ho',
      [80, 17, 0, 0, 1080, 105, 34, 8, 22, 4, 26, 1.05, 72],
      N('Vai Kề Vai', 'Đồng đội đứng cạnh nhận thêm 8% giáp và kháng phép.',
        { hao: { giap: 0.08, khang: 0.08 }, doi: true }),
    ...
    T('nhacsi', 'Nhạc Sĩ', 'ho', 'ho',
      ...
      N('Khúc Hành', 'Đồng đội quanh mình luôn được +10% tốc chạy.',
        { hao: { tocchay: 0.10 }, doi: true }),
      C('Nốt Ru', 'Ru ngủ một mục tiêu 1.4 giây; đánh vào thì tỉnh nhưng nhận thêm 20% sát thương.', 18,
        { kc: 1.4, danhThuc: 0.20 }),
      U('Đại Hợp Xướng', 'Toàn đội +25% tốc đánh và +15% tốc chạy trong 6 giây.', 85,
        { buff: { tocdanh: 0.25, tocchay: 0.15, giay: 6, doi: true } }),
