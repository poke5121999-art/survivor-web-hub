...
(function (G) {
  ...
  G.DOI_AI = [
    ...
    D('d_meo', 'Mèo Đá', 'MĐ', 'vn', 58, 'bamnhip',
      ['swordman', 'archer', 'priest', 'werewolf', 'pyromancer'], '#6fc4f0', 'Tí',
      'Đội trẻ nhất giải. Chưa thắng ai nhưng cũng chưa sợ ai.'),
    D('d_song', 'Sóng Xanh', 'SX', 'vn', 62, 'nuoimuon',
      ['shield_bearer', 'gunner', 'barrier_magician', 'hunter', 'pyromancer'], '#5fe0b0', 'Hạ',
      'Đá chậm, farm sạch, và thường hết giờ trước khi kịp bung.'),
    D('d_bao', 'Báo Đen', 'BĐ', 'vn', 68, 'baodau',
      ['berserker', 'ghost', 'poison_dart_hunter', 'bard', 'lightning_mage'], '#b08af0', 'Khải',
      'Mười phút đầu là của họ. Phút hai mươi thì tuỳ.'),
    D('d_dieu', 'Diều Hâu', 'DH', 'vn', 74, 'bamnhip',
      ['magic_knight', 'bomber', 'bard', 'ghost', 'shadowmancer'], '#f0a86f', 'Vũ',
      'Không có gì đặc biệt, và đó là điểm mạnh của họ.'),
    D('d_cavoi', 'Cá Voi Trắng', 'CV', 'vn', 96, 'nuoimuon',
      ['hammerer', 'werewolf', 'pyromancer', 'gunner', 'priest'], '#9fd8e8', 'Đại',
      'Chịu trận giỏi nhất giải. Ai muốn thắng phải kết liễu trước phút 25.'),
    D('d_kien', 'Kiến Lửa', 'KL', 'vn', 120, 'baodau',
      ['berserker', 'cavalry_knight', 'poison_dart_hunter', 'lightning_mage', 'bard'], '#ff7a45', 'Bảo',
      'Năm người xông vào cùng lúc. Không có kế hoạch B.'),
    D('d_ong', 'Ong Vàng', 'OV', 'vn', 140, 'bamnhip',
      ['swordman', 'hunter', 'shadowmancer', 'archer', 'barrier_magician'], '#ffcc3d', 'Nghĩa',
      'Đội kỷ luật nhất giải quốc nội. Không bao giờ tự thua.'),
    D('d_ho', 'Hổ Xám', 'HX', 'vn', 150, 'baodau',
      ['berserker', 'cavalry_knight', 'archer', 'shield_bearer', 'shadowmancer'], '#e5484d', 'Sơn',
      'Vô địch quốc nội ba mùa liền. Ai cũng muốn hạ họ.'),
    D('d_ran', 'Rắn Lục', 'RL', 'vn', 162, 'nuoimuon',
      ['hammerer', 'poison_dart_hunter', 'lightning_mage', 'barrier_magician', 'hunter'], '#3ddc97', 'Tuệ',
      'Nhường hết nửa đầu rồi siết cổ từ phút 25.'),
    D('d_soi', 'Sói Tuyết', 'ST', 'vn', 172, 'bamnhip',
      ['magic_knight', 'werewolf', 'pyromancer', 'gunner', 'priest'], '#7fd6ff', 'Lâm',
      'Không có ngôi sao nào, nhưng năm người đá như một.'),
    D('d_quy', 'Quỷ Đỏ', 'QĐ', 'vn', 186, 'bungcuoi',
      ['hammerer', 'ghost', 'lightning_mage', 'archer', 'barrier_magician'], '#ff8fb0', 'Huy',
      'Thắng đậm hoặc thua đậm. Trận nào của họ cũng đáng xem.'),

    /* ═════ QUỐC TẾ — 13 đội, gặp ở chung kết thế giới ═════ */
    D('d_gio', 'Gió Bắc', 'GB', 'qt', 252, 'bamnhip',
      ['swordman', 'cavalry_knight', 'shadowmancer', 'gunner', 'bard'], '#a8c4d8', 'Wen',
      'Khu vực lạnh nhất, lối chơi cũng lạnh nhất.'),
    D('d_bacau', 'Bạch Âu', 'BA', 'qt', 254, 'nuoimuon',
      ['magic_knight', 'werewolf', 'lightning_mage', 'poison_dart_hunter', 'priest'], '#e8e4d8', 'Leon',
      'Đại diện phương Tây. Đá dài, đá chắc, không ai thích gặp.'),
    D('d_hai', 'Hải Lang', 'HL', 'qt', 262, 'baodau',
      ['berserker', 'ghost', 'archer', 'shield_bearer', 'pyromancer'], '#3f8fd0', 'Kaito',
      'Invade từ giây thứ mười. Có mùa vô địch, có mùa về bét.'),
    D('d_rong', 'Rồng Vàng', 'RV', 'qt', 268, 'bamnhip',
      ['magic_knight', 'cavalry_knight', 'pyromancer', 'gunner', 'barrier_magician'], '#ffd76e', 'Long',
      'Đội đông fan nhất thế giới. Áp lực khán giả là vũ khí của họ.'),
    D('d_thien', 'Thiên Lôi', 'TL', 'qt', 274, 'bungcuoi',
      ['hammerer', 'hunter', 'lightning_mage', 'bomber', 'bard'], '#c9a0ff', 'Rai',
      'Chờ giao tranh tổng cuối rồi xoá sổ. Không quan tâm phút 10.'),
    D('d_phuong', 'Phượng Bạc', 'PB', 'qt', 280, 'bungcuoi',
      ['shield_bearer', 'werewolf', 'lightning_mage', 'archer', 'bard'], '#c8d3e0', 'Mira',
      'Lật kèo là nghề. Thua 0-2 vẫn chưa ai dám ăn mừng.'),
    D('d_hoa', 'Hoả Diệm', 'HD', 'qt', 286, 'baodau',
      ['berserker', 'ghost', 'poison_dart_hunter', 'shadowmancer', 'barrier_magician'], '#ff6b3d', 'Yan',
      'Đá nhanh tới mức đối thủ chưa kịp mua đồ thứ hai.'),
    D('d_lang', 'Lang Vương', 'LV', 'qt', 300, 'baodau',
      ['berserker', 'ghost', 'shadowmancer', 'poison_dart_hunter', 'bard'], '#a77bf3', 'Fen',
      'Đi rừng hay nhất thế giới, và cả đội đá quanh người đó.'),
    D('d_bang', 'Băng Nguyên', 'BN', 'qt', 322, 'nuoimuon',
      ['hammerer', 'werewolf', 'pyromancer', 'gunner', 'priest'], '#8fe0ff', 'Ise',
      'Bốn mươi phút không phải trận dài, với họ đó là kế hoạch.'),
    D('d_thanh', 'Thánh Chiến', 'TC', 'qt', 334, 'bamnhip',
      ['magic_knight', 'cavalry_knight', 'lightning_mage', 'archer', 'priest'], '#f2c94c', 'Sein',
      'Không có điểm yếu nào đủ lớn để khai thác.'),
    D('d_sat', 'Sắt Đen', 'SĐ', 'qt', 340, 'bungcuoi',
      ['hammerer', 'hunter', 'shadowmancer', 'bomber', 'barrier_magician'], '#8a939e', 'Dorn',
      'Ba lần á quân thế giới. Mùa nào cũng nói mùa này là của mình.'),
    D('d_vang', 'Vàng Ròng', 'VR', 'qt', 352, 'baodau',
      ['swordman', 'cavalry_knight', 'pyromancer', 'archer', 'bard'], '#f5d76e', 'Aru',
      'Mua sạch ngôi sao của mọi khu vực. Và nó có tác dụng.'),
    D('d_vuong', 'Vương Triều', 'VT', 'qt', 356, 'nuoimuon',
      ['hammerer', 'werewolf', 'pyromancer', 'gunner', 'barrier_magician'], '#4a9df8', 'Zhe',
